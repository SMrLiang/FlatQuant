...
class FlatQuantQwen2Attention(Qwen2Attention):
    ...
    def forward(self, hidden_states, position_embeddings, attention_mask, past_key_value, cache_position=None, **kwargs):
        ...
        self.k_mse += torch.nn.functional.mse_loss(ori_key_states, key_states, reduction='mean')
        self.v_mse += torch.nn.functional.mse_loss(ori_value_states, value_states, reduction='mean')        
        self.mse_cnt += 1
